...
USE_FAKE_SETTINGS = False

STORAGE_ACCOUNT_NAME = os.environ.get('STORAGE_ACCOUNT_NAME', '')
STORAGE_ACCOUNT_KEY = os.environ.get('STORAGE_ACCOUNT_KEY', '')
BLOB_STORAGE_ACCOUNT_NAME = os.environ.get('BLOB_STORAGE_ACCOUNT_NAME', '')
BLOB_STORAGE_ACCOUNT_KEY = os.environ.get('BLOB_STORAGE_ACCOUNT_KEY', '')
REMOTE_STORAGE_ACCOUNT_NAME = os.environ.get('REMOTE_STORAGE_ACCOUNT_NAME', '')
REMOTE_STORAGE_ACCOUNT_KEY = os.environ.get('REMOTE_STORAGE_ACCOUNT_KEY', '')
PREMIUM_STORAGE_ACCOUNT_NAME = os.environ.get('PREMIUM_STORAGE_ACCOUNT_NAME', '')
PREMIUM_STORAGE_ACCOUNT_KEY = os.environ.get('PREMIUM_STORAGE_ACCOUNT_KEY', '')
